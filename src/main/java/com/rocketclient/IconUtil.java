 ...
 * ~/.rocketclient/instance-icons/ on import so they survive even if the
 * user moves or deletes the original file they picked.
 */
public class IconUtil {

    private static final Path CUSTOM_ICONS_DIR = Paths.get(System.getProperty("user.home"), ".rocketclient", "instance-icons");
