...
public class LogViewerWindow {
    ...
    private static final Path LAUNCHER_LOG = Paths.get(System.getProperty("user.home"), ".rocketclient", "logs", "launcher-latest.log");
    private static final Path MC_LOG       = Paths.get(System.getProperty("user.home"), ".rocketclient", "minecraft", "logs", "minecraft-latest.log");
    private static final Path FORGE_LOG    = Paths.get(System.getProperty("user.home"), ".rocketclient", "minecraft", "logs", "forge-latest.log");
    private static final Path LOGS_DIR     = Paths.get(System.getProperty("user.home"), ".rocketclient", "logs");
    ...
    public static void open() {
        ...
        RocketWindowChrome.apply(stage, "LOGS", root, 860, 620, null);
